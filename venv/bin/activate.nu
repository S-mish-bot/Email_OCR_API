...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/mishadey/Desktop/Zaggle/OCRs/Invoice-OCR/azure_invoice_ocr_docker_app/venv'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/mishadey/Desktop/Zaggle/OCRs/Invoice-OCR/azure_invoice_ocr_docker_app/venv/bin/deactivate.nu'
